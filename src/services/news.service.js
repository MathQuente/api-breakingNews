...
export const byUserService = id =>
  News.find({ user: id }).sort().populate('user')
...
export const deleteCommentService = (idNews, idComment, userId) => News.findByIdAndUpdate({_id: idNews}, {$pull: {comments: {idComment, userId}}})